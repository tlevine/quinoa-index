...
CREATE TABLE IF NOT EXISTS page_source (
  ...
  UNIQUE(page_number)
    ...
    while True:
        ...
        ellipsis = ellipses[-1] # So we get the ascending rather than descending ellipses
        ...
        if previous_page_saved + 1 == page_number:
            # If we're up to this page, save it.
            pass
        elif previous_page_saved + 1 <= max_page_number:
        ...
        try:
            a = page_numbers[0].find_element_by_xpath('../following-sibling::td[position()=1]/a')
